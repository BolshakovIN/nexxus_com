<?php  //[STAMP] 0943e7431a67e4d636753a8a1d1ac270
...
trait AcceptanceTesterActions
{
     ...
     *
     * @throws Exception
     * @see \Helper\Acceptance::clickOnElementAfterWaitingItClickable()
     */
    public function clickOnElementAfterWaitingItClickable(string $elementSelector, int $timeout = 15): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('clickOnElementAfterWaitingItClickable', func_get_args()));
    }
     ...
     *
     * @throws Exception
     * @see \Helper\Acceptance::fillFieldAfterWaitingElementVisible()
     */
    public function fillFieldAfterWaitingElementVisible(string $elementSelector, string $textValue, int $timeout = 15): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('fillFieldAfterWaitingElementVisible', func_get_args()));
    }
     ...
     *
     * @throws Exception
     * @see \Helper\Acceptance::checkOptionAfterWaitForElementClickable()
     */
    public function checkOptionAfterWaitForElementClickable(string $elementSelector, int $timeout = 15): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('checkOptionAfterWaitForElementClickable', func_get_args()));
    }
     ...
     *
     * @throws Exception
     * @see \Helper\Acceptance::selectOptionAfterWaitForElementClickable()
     */
    public function selectOptionAfterWaitForElementClickable(string $elementSelector, string $elementName, int $timeout = 15): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('selectOptionAfterWaitForElementClickable', func_get_args()));
    }
     ...
     *
     * @see \Codeception\Module\WebDriver::type
     * @see \Helper\Acceptance::fillFieldWithDelay()
     */
    public function fillFieldWithDelay($field, $text, $delay = 60) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('fillFieldWithDelay', func_get_args()));
    }
     ...
     * @see \Helper\Acceptance::waitForPopup()
     */
    public function waitForPopup(int $secondToWait = 15) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('waitForPopup', func_get_args()));
    }
     ...
     * @see \Helper\Acceptance::acceptAlert()
     */
    public function acceptAlert(int $numberOfAlerts = 1, int $secondToWait = 15) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('acceptAlert', func_get_args()));
    }
     ...
     * @see \Helper\Acceptance::getDynamicallyIFrameName()
     */
    public function getDynamicallyIFrameName() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getDynamicallyIFrameName', func_get_args()));
    }
     ...
     * @see \Helper\Acceptance::waitNewOpenWindow()
     */
    public function waitNewOpenWindow(int $timeout = 10) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('waitNewOpenWindow', func_get_args()));
    }
     ...
     * @param int $timeout - таймаут ожидания
     * @see \Helper\Acceptance::waitAllOpenWindows()
     */
    public function waitAllOpenWindows($numberOfWindow, int $timeout = 30) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('waitAllOpenWindows', func_get_args()));
    }
     ...
     * @see \Helper\Acceptance::goToActiveWindow()
     */
    public function goToActiveWindow() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('goToActiveWindow', func_get_args()));
    }
     ...
     * @see \Helper\Acceptance::getConstant()
     */
    public function getConstant(string $objectOrClass, string $nameConstant): mixed {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getConstant', func_get_args()));
    }
     ...
     * @see \Helper\Acceptance::waitDuringIteration()
     */
    public function waitDuringIteration(callable $whatWeCheck, string $error = "\u041e\u0448\u0438\u0431\u043a\u0430 \u0432\u043e \u0432\u0440\u0435\u043c\u044f \u0438\u0442\u0435\u0440\u0430\u0446\u0438\u0438", int $max = 15, ?callable $whatDoWeDoIfThereIsError = NULL): mixed {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('waitDuringIteration', func_get_args()));
    }
